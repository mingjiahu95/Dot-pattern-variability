function [Pr_resp_pat,Pr_corr_pat,Pr_corr] = PM_baseline(params,condition)
...
switch condition
    case 1
       S_within_old = S_within_low;
    case 2
       S_within_old = S_within_med;
    case 3
       S_within_old = S_within_high;
end
...
Pr_corr_newhigh_special = Pr_corr_newhigh;
Pr_corr_pat.newhigh_special = repmat(Pr_corr_newhigh_special,[3,1]); 
Pr_resp_pat.newhigh_special = [[Pr_corr_newhigh_special,(1-Pr_corr_newhigh_special)/2,(1-Pr_corr_newhigh_special)/2];[(1-Pr_corr_newhigh_special)/2,Pr_corr_newhigh_special,(1-Pr_corr_newhigh_special)/2];[(1-Pr_corr_newhigh_special)/2,(1-Pr_corr_newhigh_special)/2,Pr_corr_newhigh_special]];

Pr_corr = [Pr_corr_old,Pr_corr_proto,Pr_corr_newlow,Pr_corr_newmed,Pr_corr_newhigh,Pr_corr_newhigh_special];
end